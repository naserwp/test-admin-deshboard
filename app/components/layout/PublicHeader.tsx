...
export default function PublicHeader() {
  ...
  const headerLinkClass = (active: boolean) =>
    [
      ...
      active
        ? "bg-slate-100/80 text-slate-900 shadow-sm dark:bg-white/10 dark:text-white"
          ...
          <div className="relative" onKeyDown={handleProductKeyDown}>
            ...
            {isProductOpen ? (
              <div
                ...
                ref={panelRef}
                role="menu"
                className="absolute left-0 top-full z-[60] mt-2 w-56 rounded-2xl border border-slate-200/70 bg-white/90 p-2 text-sm text-slate-700 shadow-xl backdrop-blur dark:border-slate-700/60 dark:bg-slate-950/90 dark:text-slate-100"
              >
