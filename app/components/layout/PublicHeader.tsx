...
export default function PublicHeader() {
  ...
  return (
    <header className="sticky top-4 z-50 min-h-[var(--public-header-height)] overflow-hidden rounded-3xl border border-slate-200/80 bg-white/80 shadow-sm backdrop-blur-sm dark:border-slate-800/60 dark:bg-slate-900/70">
