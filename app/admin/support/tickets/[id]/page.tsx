    ...
    <div>
      ...
      <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <Link href="/admin/support/tickets" className="text-sm text-indigo-600 hover:text-indigo-700">
              ← Back to tickets
            </Link>
            ...
            <p className="text-sm text-slate-500">{ticket.visitorEmail || "No email on file"}</p>
          </div>
